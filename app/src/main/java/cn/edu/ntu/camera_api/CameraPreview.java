...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private Size properPictureSize;
    private Size properPreviewSize;
    ...
    public Size getMaxSize(List<Size> list){       //max
     ...
     */
    public Size getProperSize(List<Size> list, int width,int height){    //proper size filtered by screenratio
        Collections.sort(list,sizeComparator);
        Size tempSize,flagSize=null;
